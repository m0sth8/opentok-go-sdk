...
func (ot *OpenTok) CreateSession(opts *SessionOptions) (*Session, error) {
	return ot.CreateSessionCtx(context.Background(), opts)
}

// CreateSessionCtx generates a new session. Uses context for http requests.
func (ot *OpenTok) CreateSessionCtx(ctx context.Context, opts *SessionOptions) (*Session, error) {
	params := url.Values{}
